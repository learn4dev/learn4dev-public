...
<div id="layout-content">
    ...
    <div class="container">
        ...
        <p>
            The learn4dev Network uses cookies on this website 
            (the "Service").
            By using this Service, you consent to the use of cookies.
        </p>
        <p>
        ...
        <p>
            ...
            browser and allows the Service or a third-party to recognise
        ...
        <h3>How the learn4dev Network uses cookies</h3>
        <p>
        ...
        <p>
            ...
            functions of the Service, to provide analytics, to store 
            your preferences, to enable advertisements delivery, 
        ...
        <ul>
            ...
            <li>
                Third-party cookies: In addition to our own cookies, 
                we may also use various third-parties cookies to report
                usage statistics of the Service, deliver advertisements
        ...
        <ul>
            ...
            <li>
                Network advestising Initiative:  <a href="http://www.networkadvertising.org/">http://www.networkadvertising.org/</a> 
            </li>
        </ul>
        </p>
